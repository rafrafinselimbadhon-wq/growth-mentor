...
Growth Mentor is a goal-tracking app anchored to a 10-year Vision, with a weekly scorecard engine that rates progress across health, soft skills, education, and career — replacing an expensive human coach.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "324124486+rafrafinselimbadhon-wq@users.noreply.github.com"
  git config user.name "rafrafinselimbadhon-wq"
  ```
